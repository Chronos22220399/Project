    ...
    static SystemUpdateLogDTO from_json(const nlohmann::json& j) {
        try {
            return SystemUpdateLogDTO{
                .external_id = j.at("external_id").get<std::string>(),
...
.updated_at = utils::string_to_datetime(j.at("updated_at").get<std::string>()),
...
inline void to_json(nlohmann::json &j, const SystemUpdateLogDTO& system_update_log_dto) {
    j = nlohmann::json{
        {"id", system_update_log_dto.id},
{"external_id", system_update_log_dto.external_id},
{"version", system_update_log_dto.version},
{"user_id", SystemUpdateLogDTO::getExternalId("user",system_update_log_dto.user_rk_id)},
...
namespace model {
template <>
struct ReflectTable<SystemUpdateLogDTO, db::system_update_log> {
    static constexpr auto map_members = std::make_tuple(
        std::make_pair(&SystemUpdateLogDTO::id, &db::system_update_log::id),
std::make_pair(&SystemUpdateLogDTO::external_id, &db::system_update_log::external_id),
std::make_pair(&SystemUpdateLogDTO::version, &db::system_update_log::version),
std::make_pair(&SystemUpdateLogDTO::user_rk_id, &db::system_update_log::user_rk_id),
std::make_pair(&SystemUpdateLogDTO::update_type, &db::system_update_log::update_type),
std::make_pair(&SystemUpdateLogDTO::updated_at, &db::system_update_log::updated_at),
std::make_pair(&SystemUpdateLogDTO::description, &db::system_update_log::description),
std::make_pair(&SystemUpdateLogDTO::change_summary, &db::system_update_log::change_summary),
std::make_pair(&SystemUpdateLogDTO::affected_modules, &db::system_update_log::affected_modules)
    );
};

// mapping
template <typename System_update_logRow> struct ReflectTableRow<SystemUpdateLogDTO, System_update_logRow> {
