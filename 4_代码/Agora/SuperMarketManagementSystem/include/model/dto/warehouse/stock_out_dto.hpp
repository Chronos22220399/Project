...
.destination_type = j.at("destination_type").get<std::string>(),
.destination_reference = j.at("destination_reference").get<in_id_type>(),
...
{"warehouse_rk_id", stock_out_dto.warehouse_rk_id},
{"created_at", utils::time_to_string(stock_out_dto.created_at)},
{"created_by", stock_out_dto.created_by},
...
namespace model {
template <>
struct ReflectTable<StockOutDTO, db::stock_out> {
    static constexpr auto map_members = std::make_tuple(
        std::make_pair(&StockOutDTO::id, &db::stock_out::id),
std::make_pair(&StockOutDTO::stock_out_id, &db::stock_out::stock_out_id),
std::make_pair(&StockOutDTO::warehouse_rk_id, &db::stock_out::warehouse_rk_id),
std::make_pair(&StockOutDTO::created_at, &db::stock_out::created_at),
std::make_pair(&StockOutDTO::created_by, &db::stock_out::created_by),
std::make_pair(&StockOutDTO::destination_type, &db::stock_out::destination_type),
std::make_pair(&StockOutDTO::destination_type, &db::stock_out::destination_type),
std::make_pair(&StockOutDTO::destination_reference, &db::stock_out::destination_reference),
...
// mapping
template <typename Stock_outRow> struct ReflectTableRow<StockOutDTO, Stock_outRow> {
