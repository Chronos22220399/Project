...
select_ret_type<StockInDTO> StockInRepository::get(const std::string& stock_in_name) {
  return _select(db::stock_in{}.stock_in_name == stock_in_name);
};
...
count_type StockInRepository::count() { return _count(); }
