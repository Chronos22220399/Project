...
void SystemUpdateLogController::registerRoutes(crow::SimpleApp& app) {
    ...
    CROW_ROUTE(app, "/api/system_update_log/update")
        .methods("POST"_method)([](const crow::request& req) {
            ...
            auto system_update_log_dto = SystemUpdateLogDTO::from_json(j);
            auto system_update_log_id = system_update_log_dto.system_update_log_id;
            
            auto res = SystemUpdateLogService::updateBySystemUpdateLogId(system_update_log_id, system_update_log_dto);
    ...
    CROW_ROUTE(app, "/api/system_update_log/remove")
        .methods("POST"_method)([](const crow::request& req) {
            ...
            auto system_update_log_id = j.at("system_update_log_id").get<ex_id_type>();
            
            auto res = SystemUpdateLogService::removeBySystemUpdateLogId(system_update_log_id);
    ...
    CROW_ROUTE(app, "/api/system_update_log/getAll")
        .methods("GET"_method)([]() {
