...
void SupplierContractController::registerRoutes(crow::SimpleApp& app)
{
  ...
  CROW_ROUTE(app, "/api/supplier_contract/update")
    .methods("POST"_method)([](const crow::request& req) {
      ...
      auto supplier_contract_dto = SupplierContractDTO::from_json(j);
      auto supplier_contract_id = supplier_contract_dto.contract_id;

      auto res = SupplierContractService::updateBySupplierContractId(
        supplier_contract_id, supplier_contract_dto);
  ...
  CROW_ROUTE(app, "/api/supplier_contract/remove")
    .methods("POST"_method)([](const crow::request& req) {
      ...
      auto supplier_contract_id =
        j.at("supplier_contract_id").get<ex_id_type>();

      auto res = SupplierContractService::removeBySupplierContractId(
  ...
  CROW_ROUTE(app, "/api/supplier_contract/getAll").methods("GET"_method)([]() {
