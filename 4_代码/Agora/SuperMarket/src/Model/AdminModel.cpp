...
template <typename AdminTableRow> struct ReflectTableRow<AdminModel::Admin, AdminTableRow> {
...
struct AdminModel::AdminModelImpl: public GenericModel<AdminModel::Admin, Admin_::Admin>
{
