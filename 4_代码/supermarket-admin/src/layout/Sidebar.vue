...
const menuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            { name: "积分兑换物品管理", path: "pointExchangeGoods" },
        ],
    },
    {
        name: "销售管理",
...
<template>
    <el-menu :default-active="activeMenu" class="el-menu-vertical sidebar-menu" router>
...
.sidebar-menu {
    min-height: 100vh;
    height: 100%;
    background: linear-gradient(to bottom, #f0f4ff, #dde6ff, #d1e0ff);
    padding-bottom: 90px;
    position: relative;
}
